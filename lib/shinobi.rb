...
module Shinobi
  ...
  def self.fetch
    base_list = MultiJson.decode(`node #{NINJA} | tail -n +2`)
  ...
  def self.select_driver(driver_name)
    ...
    when "HP LaserJet 9050 PS", "HP LaserJet 9050 Series PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-laserjet_9050-ps.ppd"
    when "HP Color LaserJet 4700 PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-color_laserjet_4700-ps.ppd"
    when "HP Color LaserJet 5500 PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-color_laserjet_5500-ps.ppd"
    when "HP LaserJet 8150 Series PS", "HP LaserJet 8150 PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-laserjet_8150_mfp-ps.ppd"
    ...
    when "HP LaserJet 4000 PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-laserjet_4000_series-ps.ppd"
    when "HP LaserJet 4350 PS", "HP LaserJet 4350 Series PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-laserjet_4350-ps.ppd"
    when "HP LaserJet 4200 Series PS", "HP LaserJet 4200 PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-laserjet_4200-ps.ppd"
    when "HP Color LaserJet 4650 PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-color_laserjet_4650-ps.ppd"
    ...
    when "HP LaserJet 4300 Series PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-laserjet_4300-ps.ppd"
    when "HP LaserJet 5100 PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-laserjet_5100_series-ps.ppd"
    when "HP LaserJet 5200 PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-laserjet_5200-ps.ppd"
    when "HP LaserJet 4050 Series PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-laserjet_4050_series-ps.ppd"
    when "HP LaserJet P4515", "HP LaserJet P4515 Series PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-laserjet_p3005-ps.ppd"
    when "HP LaserJet 8100 Series PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-laserjet_8100_mfp-ps.ppd"
    when "HP LaserJet 4250 PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-laserjet_4250-ps.ppd"
    when "HP LaserJet 9000 Series PS"
      "-m postscript-hp:0/ppd/hplip/HP/hp-laserjet_9000_series-ps.ppd"
    else
